...
type Forecaster interface {
	GetForecast(ctx context.Context, loc model.Location) (*WeatherReading, error)
}
...
func FetchAll(ctx context.Context, loc model.Location, providers []NamedForecaster) []ProviderReading {
