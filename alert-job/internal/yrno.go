...
func (y *YrNo) GetForecast(ctx context.Context, loc model.Location) (*WeatherReading, error) {
	...
	req.Header.Set("User-Agent", "wind-alert/1.0 github.com/majalcmaj/wind-alert")
